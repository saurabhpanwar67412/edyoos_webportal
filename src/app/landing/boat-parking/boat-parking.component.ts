...
export class BoatParkingComponent extends SearchBaseComponent
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve Boat Parking Online' }
    );
    this.metaTagService.updateTag(
      {
        name: 'description', content: 'Reserve parking for your boat. Find parking by boat size. Contact-free, ' +
          'cash-free online parking. Reserve and pay online, find your boat parking space with real-time ' +
          'tracking, park on the spot. Hassle-free. Choose your boat parking spot.'
      }
    );

    this.metaTagService.updateTag(
      {
        name: 'keywords', content: 'parking, parking reservations, reserved parking, boat parking, dock parking, reserve ' +
          'boat parking'
      }
    );
