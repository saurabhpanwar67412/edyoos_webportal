...
implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve Truck &amp; Trailer Parking Online' }
    );
    this.metaTagService.updateTag(
      { name: 'description', content: 'Reserve truck &amp; trailer parking ahead of time for your next trip. Find parking '+
      'for your truck and boat trailer, camper, and more. Contact-free, cash-free online parking. '+
      'Reserve and pay online, find your parking space with real-time tracking, park on the spot. '+
      'Hassle-free. Choose your parking spot.' }
    );

    this.metaTagService.updateTag(
      { name: 'keywords', content: 'parking, parking reservations, reserved parking, truck and trailer parking, truck '+
      'parking, trailer parking, camper parking' }
    );
