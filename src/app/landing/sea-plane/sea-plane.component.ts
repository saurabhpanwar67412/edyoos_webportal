...
export class SeaPlaneComponent extends SearchBaseComponent
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve Seaplane Parking Online' }
    );
    this.metaTagService.updateTag(
      {
        name: 'description', content: 'Reserve parking for your seaplane. Contact-free, cash-free online parking. '+
        'Reserve and pay online, find your seaplane parking space with real-time tracking, park on the '+
        'spot. Hassle-free. Choose your seaplane parking spot.'
      }
    );

    this.metaTagService.updateTag(
      {
        name: 'keywords', content: 'parking, parking reservations, reserved parking, seaplane parking, airplane parking'
      }
    );
