...
export class SemiTruckComponent extends SearchBaseComponent
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve Semi-Truck Parking Online' }
    );
    this.metaTagService.updateTag(
      {
        name: 'description', content: 'Reserve parking for your semi-truck or fleet. Secure parking for truckers or ' +
          'fleets. Reserve nightly, weekly, or monthly. Short-term and long-term reservations. Contact-free, ' +
          'cash-free online parking. Reserve and pay online, find your truck parking space with real-time ' +
          'tracking, park on the spot. Hassle-free. Choose your semi-truck parking spot.'
      }
    );

    this.metaTagService.updateTag(
      {
        name: 'keywords', content: 'parking, parking reservations, reserved parking, truck parking, semi-truck parking, ' +
          'fleet parking, parking for truckers'
      }
    );
