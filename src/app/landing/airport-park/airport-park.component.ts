...
export class AirportParkComponent extends SearchBaseComponent
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve Airport Parking Online' }
    );
    this.metaTagService.updateTag(
      {
        name: 'description', content: 'Reserve airport parking for your next flight. Free shuttle, 24-hour security, ' +
          'and luggage assistance. Find parking for MIA, FLL, ATL, SEA, EWR, MCO, DAL, OAK, and ' +
          'more. Park and fly. Contact-free, cash-free online parking. Reserve and pay online, find your ' +
          'parking space with real-time tracking, park on the spot. Hassle-free. Choose your airport parking ' +
          'spot.'
      }
    );
    ...
    this.metaTagService.updateTag(
      {
        name: 'keywords', content: 'parking, parking reservations, reserved parking, airport parking, park and fly, park &amp; ' +
          'fly'
      }
    );
