...
export class CityParkComponent extends SearchBaseComponent
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'title', content: 'Reserve City Parking Online' }
    );
    this.metaTagService.updateTag(
      { name: 'description', content: 'Reserve city parking ahead of time. Contact-free, cash-free online parking. '
    ...
    this.metaTagService.updateTag(
      { name: 'keywords', content: 'parking, parking reservations, reserved parking, event parking, city parking' }
    );
